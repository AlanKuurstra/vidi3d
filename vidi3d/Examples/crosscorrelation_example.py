...
correlationMap=correlate(normalized,boldSignal[np.newaxis,np.newaxis,:],mode='valid')
correlationMap=correlationMap.max(axis=-1)
v.compare2d(img,overlay=correlationMap, windowTitle="Cross correlation example", overlayColormap='seismic')
